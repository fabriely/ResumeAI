  ...
  return (
    <main className="relative bg-[#F4F0FF] flex flex-col md:flex-row items-center justify-between px-10 py-20 w-full min-h-screen">
      ...
      <div className="max-w-6xl z-20 mt-16 md:mt-0">
        <h2 className="text-[#000000] text-5xl md:text-7xl font-light ml-12 leading-tight">
        ...
        <p className="mt-4 text-lg md:text-2xl text-[#5331CF] text-opacity-65 font-semibold ml-12">
